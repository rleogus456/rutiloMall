<?php /* Template_ 2.2.6 2014/09/29 15:56:49 /www/rutilo_firstmall_kr/data/email/withdrawal.html 000005526 */  $this->include_("defaultScriptFunc");?>
<html>
<head>
<!--style>
body{font-size:10px;}
...
<table border="0" cellSpacing="0" cellPadding="0" width="696">
	<tbody><tr><td height="20" style="color:#4D4D4D; font-size:12px; line-height:14px"></td></tr>
	<tr>
	...
	<!-- 내용시작 -->
	<tr>
		<td style="color:#4D4D4D; font-size:12px; line-height:14px"><img src="/data/mail/txt_withdrawal.gif"></td>
	</tr>
	<tr><td height="35" style="color:#4D4D4D; font-size:12px; line-height:14px"></td></tr>
	<tr><td class="texts" style="color:#4D4D4D; font-size:12px; line-height:14px"><b><?php echo $TPL_VAR["basic"]["shopName"]?></b>입니다.</td></tr>
	<tr><td class="texts" style="color:#4D4D4D; font-size:12px; line-height:14px"><p>회원 탈퇴가 처리되어 모든 정보가 삭제되었습니다.</p></td></tr>
	<tr><td height="20" style="color:#4D4D4D; font-size:12px; line-height:14px"></td></tr>
	<tr>
		<td align="center" style="color:#4D4D4D; font-size:12px; line-height:14px">


		<table class="info-table-style" width="676" style="border-collapse:collapse; border-top:1px solid #aaa; border-right:1px solid #dadada;">
		<colgroup><col width="20%"><col width="80%">
		<tbody><tr>
			<th class="its-th" style="color:#4D4D4D; font-size:12px; line-height:14px; border-left:1px solid #dadada; border-bottom:1px solid #dadada; padding:8px 0px 8px 28px; text-align:left; background-color:#f1f1f1; font-weight:normal;">탈퇴일시</th>
			<td class="its-td" style="color:#4D4D4D; font-size:12px; line-height:14px; border-left:1px solid #dadada; border-bottom:1px solid #dadada; padding:5px 0 5px 15px; line-height:180%; letter-spacing:0px;"><?php echo $TPL_VAR["regist_date"]?></td>
		</tr>
		</tbody></table>
	...
	<tr><td height="200" style="color:#4D4D4D; font-size:12px; line-height:14px"></td></tr>
	<tr>
